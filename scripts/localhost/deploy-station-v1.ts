...
import StationContract from "../../abi/localhost/DiiRStation.json"

async function main() {
  const DiiRStationV1 = await ethers.getContractFactory("DiiRStationV1")
  ...
  await fs.writeFile(
    path.join(__dirname, "../..", "/abi/localhost/DiiRStationV1.json"),
    JSON.stringify(data)
  )
}
